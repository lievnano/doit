...
.factory('OpenFB', function ($rootScope, $q, $window, $http) {
    ...
    var FB_LOGIN_URL = 'http://doitDomainName.azurewebsites.net'; // change these routes to whichever domain name is chosen for deployed site
    // By default we store fbtoken in sessionStorage. This can be overriden in init()
    var localStorage = window.localStorage;
    var oauthRedirectURL = 'http://doitDomainName.azurewebsites.net';
